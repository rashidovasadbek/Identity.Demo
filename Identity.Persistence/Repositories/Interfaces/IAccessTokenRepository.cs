...
public interface IAccessTokenRepository
{
    ...
    /// </summary>
    /// <param name="accessToken"> The access token entity to be created</param>
    ...
    ValueTask<AccessToken> CreateAccess(AccessToken accessToken, CommandOptions commandOptions, CancellationToken cancellationToken);
